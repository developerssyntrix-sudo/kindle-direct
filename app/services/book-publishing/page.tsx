...
export const metadata: Metadata = {
  title: "Book Publishing Services — Amazon kindle direct publishing house Experts | Kindle Direct Publishing House",
  description:
    "Professional Amazon kindle direct publishing house publishing services. ISBN assignment, metadata optimization, global distribution, and a live book in 14 days or less.",
  keywords: ["Amazon kindle direct publishing house experts", "book publishing services", "ISBN assignment", "publish book on Amazon", "Kindle Direct Publishing House publishing"],
  openGraph: {
    title: "Book Publishing Services — Amazon kindle direct publishing house Experts | Kindle Direct Publishing House",
    description: "Professional Amazon kindle direct publishing house publishing services. ISBN assignment, metadata optimization, global distribution, and a live book in 14 days or less.",
    type: "website",
  }
};
...
const steps = [
  {
    ...
    bullets: [
      "Format your book for kindle direct publishing house and print distribution with professional layout.",
    ...
    tags: ["kindle direct publishing house", "IngramSpark", "Global Distribution"],
    image:
  ...
  },
  {
    ...
    bullets: [
      "Upload your files into kindle direct publishing house and review the digital preview on every device.",
...
const faqItems = [
  ...
  {
    q: "How long does publishing on kindle direct publishing house take?",
  ...
  },
  {
    ...
    a: "Absolutely. We assign ISBNs for print and eBook, set up kindle direct publishing house and IngramSpark, and configure global marketplace distribution.",
  },
  {
...
export default function BookPublishingPage() {
  return (
    <ServicePageLayout
      ...
      description="We handle every technical detail of Amazon kindle direct publishing house publishing — from formatting and metadata to global distribution and a speedy launch."
      ...
      stats={[
        ...
        { value: "#1", label: "kindle direct publishing house-Certified Agency" },
      ]}
      steps={steps}
      faqItems={faqItems}
    />
