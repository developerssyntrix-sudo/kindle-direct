  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-amazon-orange hover:bg-amazon-orange-hover disabled:opacity-70 text-amazon-dark font-bold text-sm px-6 py-3.5 rounded transition-colors shadow-md shadow-amazon-orange/20 mt-1 outline-2 outline-offset-2 outline-amazon-orange/60"
      >
        {status === "loading" ? (
